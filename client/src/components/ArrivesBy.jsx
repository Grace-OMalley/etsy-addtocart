...
const ArrivesBy = (props) => {
  ...
  return (
    <div className="shipbox">
      ...
      <h6 className="shiptext"><b>Arrives by <div className="shiptime"><u>{timestamp}-{timestampRange}</u><ShipByInfo /></div></b> if you order today.<br /><b>Hooray!</b> This item ships free to the US.</h6>
    </div>
  )
};
